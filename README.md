...
5. Im Bild-Manager Bilder ausblenden, aktive Bilder abwaehlen oder Bilder aus der Session-Galerie loeschen.
6. In TikTok Live Studio eine Browserquelle mit `http://localhost:8501?overlay=1` anlegen.
7. Alternativ das rechte Buehnenfenster im normalen Regiepult als Fensterausschnitt zuschneiden.
